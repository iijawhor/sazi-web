  ...
  return (
    <div className="flex flex-col w-full gap-1">
      ...
      <div className="card h-48 w-full !p-1 bg-white text-black flex flex-col justify-start items-start shadow-sm">
        <button className="text-gray-600 text-xs font-semibold disabled !p-1 !pt-0 !pb-0 rounded text-sm tracking-wide font-[sans-serif] ">
          This Month
        </button>
          ...
          <div className=" w-full flex items-center justify-between">
            <div className="">
              <p className="flex items-center gap-2">
                ...
                <span className="text-xs font-[sans-serif] font-semibold text-blue-900 tracking-wide">
                  Me{" "}
                </span>
              </p>
            </div>
            <div className="">
              <p className="flex flex-col gap-1  text-sm ">
                <span className="text-blue-900 font-[sans-serif] text-xs font-semibold tracking-tight">
                  AVG HRS/DAY
                </span>
                <span className="tracking-tighter text-[#2196F3] font-semibold font-[sans-serif]">
              ...
              <p className="flex items-center gap-2">
                ...
                <span>
                  ...
                  >
                    ...
                    <path strokeLinejoin="round" d="M6 21v-2a6 6 0 0112 0v2" />

                    <circle cx="6" cy="11" r="3" />
                    <path strokeLinejoin="round" d="M2 21v-1a4 4 0 016 0v1" />

                    <circle cx="18" cy="11" r="3" />
                    <path strokeLinejoin="round" d="M16 21v-1a4 4 0 016 0v1" />
                  </svg>
                </span>
                <span className="text-xs font-[sans-serif] font-semibold text-blue-900 tracking-wide">
                  My Class{" "}
